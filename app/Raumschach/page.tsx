...
abstract class Unit{ // == piece ( 체스 기물 )
    ...
    public unitDown(){
        this.model.position.set(this.convertCol() * mapConfig.cellSize.x -13,this.layer * mapConfig.cellSize.Gap - 35 + 0.01 + 3, this.row * -mapConfig.cellSize.y + 9)
        let tempCount = 3;
        const animeId = setInterval(() => {
    ...
    public addToScene(scene: THREE.Scene): void {
        ...
        loader.load(
            ...
            (gltf) => {
                ...
                this.model.position.set(this.convertCol() * mapConfig.cellSize.x -15 + 2,this.layer * mapConfig.cellSize.Gap - 35 + 0.01, this.row * -mapConfig.cellSize.y + 15 - 6)
